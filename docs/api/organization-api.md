...
The MVP projection is file-backed/structured and redacted. It never returns API keys, environment variables, secrets, prompts or chain-of-thought. Configuration is explicitly read-only.
